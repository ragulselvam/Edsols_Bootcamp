...
export const hardwareKits: HardwareKit[] = [
  {
    ...
    fullName: "16-in-1 Building:bit Super Kit for BBC Micro:bit V2",
  ...
  },
  {
    id: "iot-kit",
    track: "IoT",
    name: "World of Module Sensor Suite",
    fullName: "World of Module Programmable Sensor & IoT Kit for Micro:bit V2",
    manufacturer: "EDSOLS Lab",
  ...
  },
  {
    id: "ai-kit",
    track: "AI",
    name: "DOFBOT AI Vision Robotic Arm",
    fullName: "DOFBOT 6-DOF AI Vision Robotic Arm Platform with ROS2 & Python",
    manufacturer: "EDSOLS Lab",
  ...
  },
  {
    ...
    fullName: "ROSMASTER X3 ROS2 AI Voice & Vision Robot with Mecanum Omnidirectional Wheels",
    manufacturer: "EDSOLS Lab",
    ...
    referenceUrl: "",
    overview: "A professional educational mobile robot with 4-wheel independent Mecanum drive for 360° omnidirectional movement, high-precision laser radar for real-time 2D/3D SLAM mapping, depth camera for visual navigation, and ROS2 Python programming.",
    specs: [
    ...
    components: [
      { name: "Laser Radar Scanner", category: "LiDAR Sensing", description: "360-degree high-frequency optical scanning for point-cloud environment mapping." },
  ...
  },
  {
    id: "tinybit-pro",
    track: "Robotics",
    name: "Tiny:bit Pro AI Visual Car",
    fullName: "Tiny:bit Pro AI Visual Smart Robot Car with Micro:bit",
    manufacturer: "EDSOLS Lab",
  ...
  },
  {
    id: "dogzilla-lite",
    track: "Robotics",
    name: "DOGZILLA-Lite AI Robot Dog",
    fullName: "DOGZILLA-Lite AI Multimodal Quadruped Bionic Robot Dog",
    manufacturer: "EDSOLS Lab",
