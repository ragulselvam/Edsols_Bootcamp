...
export const projectsData: ProjectItem[] = [
  // Robotics Projects
  {
    ...
    hardware: "Yahboom Super:bit Kit + Ultrasonic Array",
    duration: "Week 1–2",
  ...
  },
  {
    ...
    hardware: "Yahboom Super:bit + Dual IR Sensors",
    duration: "Week 2",
  ...
  // IoT Projects
  {
    ...
    difficulty: "Foundation",
    hardware: "Keyestudio Smart Home Kit + RFID Module",
    duration: "Week 2–3",
  ...
  },
  {
    ...
    difficulty: "Intermediate",
    hardware: "Keyestudio Gas & Climate Sensors + OLED",
    duration: "Week 3",
  ...
  // AI Projects
  {
    ...
    difficulty: "Advanced",
    hardware: "Yahboom DOFBOT 6-DOF Arm + HD AI Camera",
    duration: "Week 3–4",
