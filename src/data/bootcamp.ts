...
export const bootcampData: BootcampInfo = {
  ...
  datesHighlight: "Dussehra BootCamp & Special BootCamp — Registrations Open",
  contact: {
  ...
  stats: [
    ...
    },
    {
      number: "02",
      title: "Ages 6+ & 12+",
      subtitle: "Progressive Learning Tracks",
      detail: "Micro:bit & IoT for 6+, with advanced AI & Robotics training for 12+.",
    ...
    },
    {
      ...
      detail: "Designed around school schedules so students learn without academic conflicts.",
      iconName: "Clock",
    },
    {
      number: "04",
      ...
      detail: "Small cohorts of 16 students per batch, ensuring a 1:8 mentor-to-student ratio.",
      iconName: "Users",
    },
  ],
  faqs: [
