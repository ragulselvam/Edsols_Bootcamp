            ...
            return (
              <button
                ...
                className={`relative p-3.5 sm:p-5 rounded-2xl text-left transition-all duration-300 cursor-pointer overflow-hidden border ${
                  isActive
                    ? 'bg-white border-rose-400 shadow-md shadow-rose-500/10 -translate-y-0.5 sm:-translate-y-1 ring-1 ring-rose-400/20'
              ...
              >
                ...
                <div className="flex items-center justify-between mb-2 sm:mb-3">
                  <span
                    className={`text-[9px] sm:text-[10px] font-mono font-bold tracking-widest uppercase px-2 sm:px-2.5 py-0.5 rounded-full ${
                      isActive
                ...
                <div className="font-display font-black text-base sm:text-lg text-slate-900 tracking-tight">
                  {week.phase}
                </div>

                <div className="text-[11px] sm:text-xs text-slate-500 mt-0.5 sm:mt-1 truncate font-medium">
                  {week.visualTag}
                </div>
              </button>
            );
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-start">
            ...
            <div className="lg:col-span-7 space-y-4 sm:space-y-6">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed mt-2.5 sm:mt-3">
              ...
              {/* Hands-on Activities */}
              <div>
                <h4 className="text-[11px] sm:text-xs font-mono uppercase tracking-wider text-slate-500 font-bold mb-2.5 sm:mb-3">
                ...
                <div className="space-y-2 sm:space-y-2.5">
                  {activeWeek.handsOnActivities.map((act, i) => (
                    <div key={i} className="flex items-start gap-2.5 p-2.5 sm:p-3 rounded-xl bg-slate-50 border border-slate-200">
                      ...
                      <span className="text-xs text-slate-700 font-medium leading-relaxed">{act}</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="lg:col-span-5 space-y-4 sm:space-y-6">
              ...
              <div className="p-4 sm:p-5 rounded-2xl bg-slate-50 border border-slate-200">
                <h4 className="text-[11px] sm:text-xs font-mono uppercase tracking-wider text-rose-700 font-bold mb-2.5 sm:mb-3 flex items-center gap-1.5">
              ...
              <div className="p-4 sm:p-5 rounded-2xl bg-gradient-to-br from-rose-50/50 to-pink-50/30 border border-rose-200 shadow-xs">
                <div className="flex items-center gap-2 mb-2">
                  <Award className="w-4 h-4 sm:w-5 sm:h-5 text-rose-600 flex-shrink-0" />
                ...
                <div className="mt-4 pt-3 border-t border-rose-200 flex flex-wrap items-center justify-between gap-3">
